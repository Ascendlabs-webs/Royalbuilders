...
export const NAV_LINKS: readonly NavLink[] = [
  ...
  { label: "Current Listing", href: "/real-estate" },
...
export const INTERIOR_SECTIONS: readonly InteriorSection[] = [
  ...
  },
  {
    ...
    after: "/images/interior-tv-1.jpg?v=4",
...
export const TEAM = [
  { name: "D. Mukhtar", role: "Founder & Chief Executive Officer", image: "/images/team-chairman-ceo.png" },
] as const;
